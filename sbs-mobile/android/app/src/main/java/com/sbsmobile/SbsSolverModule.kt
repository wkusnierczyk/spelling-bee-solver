...
class SbsSolverModule(reactContext: ReactApplicationContext) :
    ...
    @ReactMethod
    fun solve(letters: String, present: String, repeats: Int, minLength: Int, maxLength: Int, caseSensitive: Boolean, promise: Promise) {
        ...
        try {
            ...
            val request = JSONObject().apply {
                ...
                if (minLength > 0) {
                    put("minimal-word-length", minLength)
                }
                if (maxLength > 0) {
